...
BEGIN_MESSAGE_MAP(CImportDataApp, CWinApp)
...
// 僅有的一個 CImportDataApp 物件

CImportDataApp theApp;


// CImportDataApp 初始設定

BOOL CImportDataApp::InitInstance()
{
