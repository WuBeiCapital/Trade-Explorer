...
LPDISPATCH Documents::Add()		// Added
{
	LPDISPATCH result;
	static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT;

	COleVariant var1(L"Normal.dot");
	COleVariant var2((short)0, VT_BOOL);
...
// Added
void Range::Collapse(long Direction)
{
	static BYTE parms[] = VTS_PVARIANT;
	COleVariant vDirection(Direction);
...
void Selection::Collapse(long Direction)	// Added
{
	static BYTE parms[] =
		VTS_PVARIANT;
...
// Added
void Selection::InsertSymbol(long CharacterNumber, LPCTSTR lpszFontName, long Unicode, long Bias)
{
	static BYTE parms[] =
		VTS_I4 VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;

	COleVariant vFont(lpszFontName), vUnicode(Unicode), vBias(Bias);
	InvokeHelper(0xa4, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 CharacterNumber, &vFont, &vUnicode, &vBias);
}
...
// Added
long Selection::MoveDown(long Unit, long Count, long Extend)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;

	COleVariant vUnit(Unit), vCount(Count), vExtend(Extend);
	InvokeHelper(0x1f7, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		&vUnit, &vCount, &vExtend);
	return result;
}

long Selection::MoveLeft(long Unit, long Count, long Extend)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
...
long Selection::MoveRight(long Unit, long Count, long Extend)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
...
//add
long Selection::HomeKey(long Unit, long Extend)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT VTS_PVARIANT;

	COleVariant vUnit(Unit), vExtend(Extend);
	InvokeHelper(0x1f8, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		&vUnit, &vExtend);
	return result;
}
...
//add
long Selection::EndKey(long Unit, long Extend)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT VTS_PVARIANT;
