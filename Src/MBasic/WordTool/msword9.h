...
const int wdRelativeVerticalPositionPage = 1;
...
typedef enum {
	...
	wdWindowStateMinimize = 1,
	wdWindowStateNormal = 2
} WdWindowState; 
...
public:
	...
	void Collapse(long Direction = wdCollapseStart);	// Added
...
public:
  ...
  void SetNameLocal(LPCTSTR newValue)
  {
  ...
  void SetLanguageID(long newValue)
  {
  ...
  void SetAutomaticallyUpdate(BOOL newValue)
  {
  ...
  void SetLanguageIDFarEast(long newValue)
  {
    static BYTE parms[] = VTS_I4 ;
...
public:
	...
	void InsertSymbol(long CharacterNumber, VARIANT* Font, VARIANT* Unicode, VARIANT* Bias);
// Added
	void InsertSymbol(long CharacterNumber, LPCTSTR lpszFontName = _T("ËÎÌו"), long Unicode = 1, long Bias = 1);
	void InsertCrossReference(VARIANT* ReferenceType, long ReferenceKind, VARIANT* ReferenceItem, VARIANT* InsertAsHyperlink, VARIANT* IncludePosition);
	void InsertCaption(VARIANT* Label, VARIANT* Title, VARIANT* TitleAutoText, VARIANT* Position);
	void CopyAsPicture();
	void SortAscending();
	...
	void Shrink();
// Added : Move series 
	long MoveDown(long Unit = wdLine, long Count = 1, long Extend = wdMove);
	long MoveLeft(long Unit = wdCharacter, long Count = 1, long Extend = wdMove);
	long MoveRight(long Unit = wdCharacter, long Count = 1, long Extend = wdMove);
	long HomeKey(long Unit = wdLine, long Extend = wdMove);
	long EndKey(long Unit = wdLine, long Extend = wdMove);
// End Added
